...
def saveModelAttriburesAndTrainingAMP(
    exp_dir, english_model, image_model, attention, contrastive_loss, optimizer, #amp,
    ...
    checkpoint = {
        "english_model": english_model.state_dict(),
    ...
    #     checkpoint[model] = audio_models[model].state_dict()
...
def loadModelAttriburesAndTrainingAMP(
    exp_dir, english_model, image_model, attention, contrastive_loss, 
    ...
    english_model.load_state_dict(checkpoint["english_model"])
