...
#         # Novel
        ...
        for test_class, imgpath, wav, dataset in episode['novel_test']['novel']:
        ...
        for known_class, imgpath, wav, dataset in episode['novel_test']['known']:
        ...
        for test_class, imgpath, wav, dataset in episode['familiar_test']['test']:
            if imgpath not in image_datapoints:
                this_image = LoadImage(imgpath, resize, image_normalize, to_tensor)
                image_datapoints[imgpath] = this_image.unsqueeze(0)
            image_labels_1[ep_num].append(test_class)
        ...
        for known_class, imgpath, wav, dataset in episode['familiar_test']['other']:
...
save_fn = Path('results/episode_data')
