            ...
            for n_n, im_emb in enumerate(novels[novel_label]['image_embeddings']):
                for familiar_label in familiars:
                    for f_n, fam_emb in enumerate(familiars[familiar_label]['image_embeddings']):
                        ...
                        if novel_label not in results: results[novel_label] = {}
                        if labels[index] not in results[novel_label]: results[novel_label][labels[index]] = 0
                        results[novel_label][labels[index]] += 1

                        if novel_label not in totals: totals[novel_label] = 0
                        totals[novel_label] += 1
