...
trial = 1
with open('results/uninitialised_analysis.csv', 'w', encoding='UTF8') as f:
    writer = csv.writer(f)
...
header = ['trial', 'audio_query', 'image_A', 'image_B', 'similarity_A', 'similarity_B', 'distance_A', 'distance_B']
trial = 1
with open('results/uninitialised_mismatched_me_analysis.csv', 'w', encoding='UTF8') as f:
    writer = csv.writer(f)
    writer.writerow(header)
    for num in tqdm(significance_dict, desc=f'Writing to csv'):
        for query in significance_dict[num]:
...
header = ['trial', 'audio_query', 'image_A', 'image_B', 'similarity_A', 'similarity_B', 'distance_A', 'distance_B']
trial = 1
with open('results/uninitialised_familiar_analysis.csv', 'w', encoding='UTF8') as f:
    writer = csv.writer(f)
    writer.writerow(header)
    for num in tqdm(significance_dict, desc=f'Writing to csv'):
        for query in significance_dict[num]:
