...
with torch.no_grad():
    ...
    image_dataset_1 = np.load(Path('results/episode_data.npz'), allow_pickle=True)['image_dataset_1'].item()
    image_dataset_2 = np.load(Path('results/episode_data.npz'), allow_pickle=True)['image_dataset_2'].item()
    ...
    for ep_num in tqdm(episodes, desc=f'{rewind}'):
        ...
        for n, name in enumerate(query[ep_num]):
            if image_dataset_1[ep_num][n] == 'caltech':
        ...
        for n, name in enumerate(image_1[ep_num]):
            if image_dataset_1[ep_num][n] == 'caltech':
                ...
                tags_1.append(query_tag[ep_num][n])
                labels_1.append(query_labels[ep_num][n])
        ...
        for n, name in enumerate(secondary_query[ep_num]):
            if image_dataset_2[ep_num][n] == 'caltech':
        ...
        for n, name in enumerate(image_2[ep_num]):
            if image_dataset_2[ep_num][n] == 'caltech':
                ...
                tags_2.append(secondary_tag[ep_num][n])
                labels_2.append(secondary_tag[ep_num][n])
