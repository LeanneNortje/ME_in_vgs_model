...
with torch.no_grad():
    ...
    audio_datapoints = np.load(Path('results/MSCOCO_episode_data.npz'), allow_pickle=True)['audio_datapoints'].item()
    image_datapoints = np.load(Path('results/MSCOCO_episode_data.npz'), allow_pickle=True)['image_datapoints'].item()

    query = np.load(Path('results/MSCOCO_episode_data.npz'), allow_pickle=True)['audio_1'].item()
    query_labels = np.load(Path('results/MSCOCO_episode_data.npz'), allow_pickle=True)['audio_labels_1'].item()
    query_tag = np.load(Path('results/MSCOCO_episode_data.npz'), allow_pickle=True)['audio_tag_1'].item()

    secondary_query = np.load(Path('results/MSCOCO_episode_data.npz'), allow_pickle=True)['audio_2'].item()
    secondary_labels = np.load(Path('results/MSCOCO_episode_data.npz'), allow_pickle=True)['audio_labels_2'].item()
    secondary_tag = np.load(Path('results/MSCOCO_episode_data.npz'), allow_pickle=True)['audio_tag_2'].item()

    image_1 = np.load(Path('results/MSCOCO_episode_data.npz'), allow_pickle=True)['image_1'].item()
    image_2 = np.load(Path('results/MSCOCO_episode_data.npz'), allow_pickle=True)['image_2'].item()
    image_labels_1 = np.load(Path('results/MSCOCO_episode_data.npz'), allow_pickle=True)['image_labels_1'].item()
    image_labels_2 = np.load(Path('results/MSCOCO_episode_data.npz'), allow_pickle=True)['image_labels_2'].item()
    image_tag_1 = np.load(Path('results/MSCOCO_episode_data.npz'), allow_pickle=True)['image_tag_1'].item()
    image_tag_2 = np.load(Path('results/MSCOCO_episode_data.npz'), allow_pickle=True)['image_tag_2'].item()
