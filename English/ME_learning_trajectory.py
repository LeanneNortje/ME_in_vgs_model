...
for args_fn in Path('model_metadata').rglob('*/args.pkl'):
    ...
    args['instance'] = int(args_fn.parent.stem)
    # print(args['instance'])
    # if args['model_name'] == 'a35ce3ce67': continue
    # if args['instance'] == 2: continue
    ...
    for epoch in range(0, args['n_epochs']+1):
        ...
        if epoch != 0:
            if (args["exp_dir"] / "models" / f'epoch_{epoch}.pt').is_file() is False: continue
